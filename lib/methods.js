...
/**
Gets the default options applied to all future requests.
@alias module:chakram.getRequestDefaults
 */
exports.getRequestDefaults = function() {
    return defaultedRequestObj;
};
